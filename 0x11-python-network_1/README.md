# Project: 0x11. Python - Network #1 | ALX Africa Intranet
...
-   You must use [get](https://intranet.alxswe.com/rltoken/ddDVKG3F084DP9byugbABw "get") to access to dictionary value by key (it wonâ€™t throw an exception if the key doesnâ€™t exist in the dictionary)
